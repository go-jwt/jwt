...
func TestRSAVerify(t *testing.T) {
	...
	for _, data := range rsaTestData {
		...
		method, _ := GetSigningFunc(SigningNames(data.alg))
...
func TestRSASign(t *testing.T) {
	...
	key, _ := util.ParseRSAPrivateKeyFromPEM(keyData)
...
func TestRSAVerifyWithPreParsedPrivateKey(t *testing.T) {
	...
	parsedKey, err := util.ParseRSAPublicKeyFromPEM(key)
	if err != nil {
		t.Fatal(err)
	}
	testData := rsaTestData[0]
	parts := strings.Split(testData.tokenString, ".")
	method, _ := GetSigningFunc("RS256")
...
func TestRSAWithPreParsedPrivateKey(t *testing.T) {
	...
	parsedKey, err := util.ParseRSAPrivateKeyFromPEM(key)
	if err != nil {
		t.Fatal(err)
	}
	testData := rsaTestData[0]
...
func TestRSAKeyParsing(t *testing.T) {
	...
	if _, e := util.ParseRSAPrivateKeyFromPEM(key); e != nil {
		t.Errorf("Failed to parse valid private key: %v", e)
	}

	if k, e := util.ParseRSAPrivateKeyFromPEM(pubKey); e == nil {
		t.Errorf("Parsed public key as valid private key: %v", k)
	}

	if k, e := util.ParseRSAPrivateKeyFromPEM(badKey); e == nil {
		t.Errorf("Parsed invalid key as valid private key: %v", k)
	}

	// Test parsePublicKey
	if _, e := util.ParseRSAPublicKeyFromPEM(pubKey); e != nil {
		t.Errorf("Failed to parse valid public key: %v", e)
	}

	if k, e := util.ParseRSAPublicKeyFromPEM(key); e == nil {
		t.Errorf("Parsed private key as valid public key: %v", k)
	}

	if k, e := util.ParseRSAPublicKeyFromPEM(badKey); e == nil {
		t.Errorf("Parsed invalid key as valid private key: %v", k)
	}
...
func BenchmarkRS256Signing(b *testing.B) {
	...
	method, _ := GetSigningFunc("RS256")
	benchmarkSigning(b, method, parsedKey)
}
